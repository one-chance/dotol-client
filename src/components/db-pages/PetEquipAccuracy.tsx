    ...
    <FlexView gap={8}>
      ...
      >
        <Select isMobile={isMobile} name={names.type} width={100}>
          <Option selected={names.type} values={TYPES} onSelect={selectType} />
        </Select>
        ...
        <Select isMobile={isMobile} name={names.face} width={100}>
          <Option selected={names.face} values={FACES} onSelect={selectFace} />
        </Select>
      ...
      <Text small={isMobile}>- 사신수는 등급별 시동 명중률이 포함됩니다.</Text>
      <Text small={isMobile}>
