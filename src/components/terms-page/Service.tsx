...
export default function Service({ isMobile }: TermsProps) {
  return (
    <FlexView gap={isMobile ? 24 : 40}>
      ...
      <FlexView gap={8}>
        ...
        <Text size={isMobile ? `xSmall` : `small`}>
          본 약관은 도톨(‘https://dotols.com’ 이하 &quot;도톨&quot;)에서
          제공하는 게임 정보 서비스 및 부수된 제반 서비스(이하
          &quot;서비스&quot;)를 이용함에 있어 도톨과 이용자의 권리, 의무 및
          책임사항, 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다.
        </Text>
      </FlexView>
      ...
      <FlexView gap={8}>
        ...
        <FlexView gap={4}>
          ...
          <FlexView css={{ paddingLeft: `8px` }} gap={4}>
            <Text size={isMobile ? `xSmall` : `small`}>
              1) “서비스”는 구현되는 단말기와 상관없이 회원이나 웹사이트
              방문자가 이용할 수 있는 도톨 서비스를 의미합니다.
            </Text>
            <Text size={isMobile ? `xSmall` : `small`}>
            ...
            <Text size={isMobile ? `xSmall` : `small`}>
              4) “아이디”는 회원의 식별 및 서비스 이용을 위하여 회원의 신청에
              따라 도톨이 회원에게 부여하는 고유한 문자와 숫자의 조합을
              말합니다.
            </Text>
            <Text size={isMobile ? `xSmall` : `small`}>
              5) “이메일”은 회원가입이나 비밀번호 찾기 등에 사용되는 단일한
              이메일 주소를 말합니다.
            </Text>
            <Text size={isMobile ? `xSmall` : `small`}>
      ...
      <FlexView gap={8}>
        ...
        <FlexView gap={4}>
          <Text size={isMobile ? `xSmall` : `small`}>
            1. “도톨”은 본 약관의 내용을 회원이 쉽게 알 수 있도록 회원가입
            화면에 게시합니다. 이용자가 회원가입을 하면 동의한 것으로
            간주됩니다.
          </Text>
          <Text size={isMobile ? `xSmall` : `small`}>
      ...
      <FlexView gap={8}>
        ...
        <FlexView gap={4}>
          ...
          <FlexView css={{ paddingLeft: `8px` }} gap={4}>
            <Text size={isMobile ? `xSmall` : `small`}>
              1) 가입신청자가 본 약관에 의하여 이전에 회원자격을 상실한 적이
              있는 경
            </Text>
            <Text size={isMobile ? `xSmall` : `small`}>
            ...
            <Text size={isMobile ? `xSmall` : `small`}>
              5) 회원의 이용 목적이나 서비스 이용 방법이 다른 회원의 서비스
              이용에 영향을 미칠 경우
            </Text>
            <Text size={isMobile ? `xSmall` : `small`}>
          ...
          <Text size={isMobile ? `xSmall` : `small`}>
            4. 회원은 “도톨”에 언제든지 회원 탈퇴를 요청하여 이용계약을 해지할
            수 있습니다.
          </Text>
        </FlexView>
      </FlexView>
      ...
      <FlexView gap={4}>
        ...
        <FlexView gap={4}>
          ...
          <Text size={isMobile ? `xSmall` : `small`}>
            3. “도톨”은 서비스를 이용하는 회원으로부터 제기되는 불만이
            정당하다고 인정할 경우, 시스템과 인력이 충분하다면 이를 처리하여야
            합니다.
          </Text>
          <Text size={isMobile ? `xSmall` : `small`}>
      ...
      <FlexView gap={4}>
        ...
        <FlexView gap={4}>
          ...
          <FlexView css={{ paddingLeft: `8px` }} gap={4}>
            ...
            <Text size={isMobile ? `xSmall` : `small`}>
              6) “도톨”이 제공 또는 승인하지 아니한 컴퓨터 프로그램이나 기기
            ...
            <Text size={isMobile ? `xSmall` : `small`}>
              8) “도톨”과 다른 회원 및 기타 제3자를 희롱하거나, 위협하거나
          ...
          <Text size={isMobile ? `xSmall` : `small`}>
            ...
            제한/정지, 수사 기관에의 고발 조치 등 합당한 조치를 취할 수
            있습니다.
          </Text>
          <Text size={isMobile ? `xSmall` : `small`}>
          ...
          <Text size={isMobile ? `xSmall` : `small`}>
            6. “도톨”은 회원이 등록한 게시물 내용이 제 1항에서 규정하는
            금지행위에 해당된다고 판단되는 경우, 사전통지 없이 삭제할 수
            있습니다.
          </Text>
        </FlexView>
      </FlexView>
      ...
      <FlexView gap={4}>
        ...
        <FlexView gap={4}>
          ...
          <Text size={isMobile ? `xSmall` : `small`}>
            2. “도톨”은 다음 각 호에 해당하는 경우에는 서비스의 제공을
            일시적으로 중단할 수 있습니다.
          </Text>
          <FlexView css={{ paddingLeft: `8px` }} gap={4}>
            <Text size={isMobile ? `xSmall` : `small`}>
            ...
            <Text size={isMobile ? `xSmall` : `small`}>
              2) 해킹 등의 사고, 회원들의 비정상적인 게임 이용행태, 미처
              예상하지 못한 서비스의 불안정성에 대응하기 위하여 필요한 경우
            </Text>
            <Text size={isMobile ? `xSmall` : `small`}>
      ...
      <FlexView gap={4}>
        ...
        <FlexView gap={4}>
          <Text size={isMobile ? `xSmall` : `small`}>
            ...
            게시물을 삭제 또는 해당 회원의 회원 자격을 제한, 정지시킬 수
            있습니다.
          </Text>
          <FlexView css={{ paddingLeft: `8px` }} gap={4}>
            <Text size={isMobile ? `xSmall` : `small`}>
      ...
      <FlexView gap={4}>
        ...
        <FlexView gap={4}>
          <Text size={isMobile ? `xSmall` : `small`}>
            ...
            불가항력적인 경우는 서비스를 예고 없이 제한하거나 중지할 수
            있습니다.
          </Text>
          <Text size={isMobile ? `xSmall` : `small`}>
          ...
          <Text size={isMobile ? `xSmall` : `small`}>
            ...
            부정이용 등으로 회원의 의무조항을 위반한 경우 ID가 제한될 수
            있습니다.
          </Text>
          <Text size={isMobile ? `xSmall` : `small`}>
          ...
          <Text size={isMobile ? `xSmall` : `small`}>
            5. 회원이 본 조에 따른 “도톨”의 이용제한에 불복하고자 할 때에는
            통보를 받은 날로부터 15일 이내에 이용제한에 불복하는 이유를 기재한
            <br />
      ...
      <FlexView gap={4}>
        ...
        <FlexView gap={4}>
          ...
          <FlexView css={{ paddingLeft: `8px` }} gap={4}>
            <Text size={isMobile ? `xSmall` : `small`}>
              1) 서비스 내에서 게시물을 사용하기 위하여 게시물의 크기를
          ...
          <Text size={isMobile ? `xSmall` : `small`}>
            5. 회원탈퇴를 하면 본인의 게시물 일체에 대한 모든 권리를 잃게
            됩니다. 작성했던 게시물은 자동으로 삭제되지 않습니다.
          </Text>
          <Text size={isMobile ? `xSmall` : `small`}>
      ...
      <FlexView gap={4}>
        ...
        <FlexView gap={4}>
          <Text size={isMobile ? `xSmall` : `small`}>
            ...
            게시중단 및 삭제 등을 요청할 수 있으며, “도톨”은 관련법에 따라
            조치를 취합니다.
          </Text>
          <Text size={isMobile ? `xSmall` : `small`}>
      ...
      <FlexView gap={4}>
        ...
        <FlexView gap={4}>
          ...
          <Text size={isMobile ? `xSmall` : `small`}>
            4. 회원이 본 조에 따른 “도톨”의 이용제한에 불복하고자 할 때에는
            통보를 받은 날로부터 15일 이내에 이용제한에 불복하는 이유를 기재한
            <br />
            &nbsp; &nbsp; 이의 신청서를 전자우편 또는 이에 준하는 방법으로
            제출하여야 합니다.
