...
export default function Privacy({ isMobile }: TermsProps) {
  return (
    <FlexView gap={isMobile ? 16 : 24}>
      ...
      <FlexView gap={4}>
        <Text size={isMobile ? `xSmall` : `small`}>
          ...
          보호법」 제30조에 따라 정부주체의 개인정보를 보호하고 이와 관련한
      ...
      <FlexView gap={8}>
        ...
        <FlexView gap={4}>
          <Text size={isMobile ? `xSmall` : `small`}>
            1. 도톨은 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
      ...
      <FlexView gap={8}>
        ...
        <FlexView gap={4}>
          ...
          <Text size={isMobile ? `xSmall` : `small`}>
            3. 제 1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은
            자 등 대리인을 통하여 하실 수 있습니다.
            <br />
      ...
      <FlexView gap={8}>
        ...
        <Text size={isMobile ? `xSmall` : `small`}>
          도톨은 개인정보로 이메일, 비밀번호, 로그인 ID 항목을 처리하고
          있습니다.
        </Text>
      </FlexView>
      ...
      <FlexView gap={8}>
        ...
        <FlexView gap={4}>
          <Text size={isMobile ? `xSmall` : `small`}>
            1. 원칙: 도톨은 개인정보 보유기간의 경과, 처리목적 달성 등
      ...
      <FlexView gap={8}>
        ...
        <FlexView gap={4}>
          ...
          <Text
            ...
            size={isMobile ? `xSmall` : `small`}
          >
            도톨은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을
            막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며
            외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로
            감시 및 차단하고 있습니다.
          </Text>
          <Text size={isMobile ? `xSmall` : `small`}>3. 개인정보의 암호화</Text>
          <Text
            css={{ paddingLeft: `8px` }}
            size={isMobile ? `xSmall` : `small`}
          >
      ...
      <FlexView gap={8}>
        ...
        <FlexView gap={4}>
          <Text size={isMobile ? `xSmall` : `small`}>
            도톨은 개인정보 처리에 관한 업무를 총괄하고, 불만처리 및 피해구제
