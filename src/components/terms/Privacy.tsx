  ...
  <FlexView css={{ margin: isMobile ? `0 10px` : 0 }} gap={32}>
    ...
    <FlexView gap={16}>
      <Text small={isMobile}>
        ...
        · 공개합니다.
        <br />
        <br />○ 본 개인정보처리방침은 2021년 3월 20일부터 적용됩니다.
      </Text>
    </FlexView>
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        {` `}
        <br />
        2) 개인정보 처리 및 보유 기간은 수집, 이용에 관한 동의일로부터 회원탈퇴
        전까지 입니다.
      </Text>
    </FlexView>
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        1) 정보주체는 도톨에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구
        등의 권리를 행사할 수 있습니다.
        <br />
        2) 제 1항에 따른 권리 행사는 도톨에 대해 「개인정보 보호법」 시행령
        제41조제1항에 따라 전자우편 등을 통하여 하실 수 있습니다.
        <br />
        3) 제 1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은 자 등
        대리인을 통하여 하실 수 있습니다.
        <br />이 경우 “개인정보 처리 방법에 관한 고시(제2020-7호)” 별지 제11호
        ...
        <br />
        6) 도톨은 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의
        요구 시 본인이거나 정당한 대리인인지를 확인합니다.
      </Text>
    </FlexView>
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        1) 도톨은 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
        불필요하게 되었을 때에는 지체 없이 해당 개인정보를 파기합니다.
        <br />
        2) 개인정보 파기의 절차 및 방법은 다음과 같습니다.
        <br />
        &nbsp;&nbsp;&nbsp;① 파기절차 : 도톨은 파기 사유가 발생한 개인정보를
        선정하고, 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
        <br /> &nbsp;&nbsp;&nbsp;② 파기방법 : 전자적 파일 형태의 정보는 기록을
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        1) 도톨은 개인정보 처리에 관한 업무를 총괄하고, 불만처리 및 피해구제
        등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
        <br />
        &nbsp;&nbsp;&nbsp;- 운영자 (admin@dotols.com)
        <br />
        <br />
        2) 정보주체께서는 도톨의 서비스를 이용하시면서 발생한 모든 개인정보 보호
        관련된 사항을 개인정보 보호책임자에게 문의하실 수 있습니다.
      </Text>
    </FlexView>
