...
export default ({ isMobile }: TermsProps) => (
  <FlexView css={{ margin: isMobile ? `0 10px` : 0 }} gap={32}>
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        <br />
        &nbsp; &nbsp;2) “회원”은 “도톨”의 이용약관에 동의하여 회원가입을 한
        자로서, “도톨”이 제공하는 서비스를 이용하는 자를 말합니다.
        <br />
        &nbsp; &nbsp;3) “이용계약”은 본 약관을 포함하여 서비스 이용과 관련하여
        “도톨”과 회원 간에 체결하는 모든 계약을 말합니다.
        <br />
        &nbsp; &nbsp;4) “아이디”는 회원의 식별 및 서비스 이용을 위하여 회원의
        신청에 따라 도톨이 회원에게 부여하는 고유한 문자와 숫자의 조합을
        말합니다.
        <br />
        &nbsp; &nbsp;5) “이메일”은 회원가입이나 비밀번호 찾기 등에 사용되는
        단일한 이메일 주소를 말합니다.
        <br />
        &nbsp; &nbsp;6) “비밀번호”는 식별되는 회원의 본인 여부를 검증하기 위해
        회원이 설정하여 도톨에 등록한 고유한 문자와 숫자의 조합을 말합니다.
        <br />
        &nbsp; &nbsp;7) “게시물”은 회원이 서비스에 게시한 문자, 문서, 그림,
        영상, 링크, 파일 혹은 이들의 조합으로 이루어진 모든 정보나 자료를
        말합니다.
      </Text>
    </FlexView>
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        있습니다.
        <br />
        3. “도톨”이 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행
        약관과 함께 적용일자로부터 최소한 7일 전부터 공지합니다.
        <br />
        4. 변경된 약관은 공지된 시점부터 그 효력이 발생하며, 회원이 본 서비스를
        계속 이용하면 변경 후의 약관에 대해 동의를 한 것으로 간주됩니다.
        <br />
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        <br />
        &nbsp; &nbsp;1) 가입신청자가 본 약관에 의하여 이전에 회원자격을 상실한
        적이 있는 경우
        <br />
        ...
        <br />
        &nbsp; &nbsp;4) “도톨”의 정책에 적합하지 않는 회원으로 판단되는 경우나
        서비스 제공이 곤란한 경우
        <br />
        &nbsp; &nbsp;5) 회원의 이용 목적이나 서비스 이용 방법이 다른 회원의
        서비스 이용에 영향을 미칠 경우
        <br />
        ...
        <br />
        &nbsp; &nbsp;8) 정보통신망 이용촉진 및 정보보호 등에 관한 법률 및 그
        밖의 관계 법령에서 금지하는 위법행위를 할 목적으로 이용신청을 하는 경우
        <br />
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        <br />
        3. “도톨”은 법률에 특별한 규정이 있는 경우를 제외하고는 회원의 별도 동의
        없이 개인정보를 제3자에게 공개하거나 제공하지 아니합니다.
      </Text>
    </FlexView>
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        됩니다.
        <br />
        3. “도톨”은 회원이 아이디 및 비밀번호를 소홀히 관리하여 발생하는 손해에
        대해 책임을 지지 않습니다.
        <br />
        4. 회원은 아이디 및 비밀번호가 도용되거나 제3자가 사용하고 있음을 인지한
        경우에는 이를 즉시 “도톨”에 통지하고 안내에 따라야 합니다.
      </Text>
    </FlexView>
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        <br />
        4. “도톨”은 정보통신망 이용촉진 및 정보보호에 관한 법률, 통신비밀보호법,
        전기통신사업법 등 운영과 관련된 법규를 준수합니다.
      </Text>
    </FlexView>
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        &nbsp; &nbsp;4) “도톨”이 게시한 정보의 변경
        <br />
        &nbsp; &nbsp;5) “도톨”이 금지한 정보(컴퓨터 프로그램 등)의 송신 또는
        게시
        <br />
        &nbsp; &nbsp;6) “도톨”이 제공 또는 승인하지 아니한 컴퓨터 프로그램이나
        기기 또는 장치를 제작, 배포, 이용, 광고하는 행위
        <br />
        &nbsp; &nbsp;7) “도톨”과 기타 제3자의 저작권, 영업비밀, 특허권 등
        지적재산권에 대한 침해
        <br />
        &nbsp; &nbsp;8) “도톨”과 다른 회원 및 기타 제3자를 희롱하거나,
        위협하거나 명예를 손상시키거나, 업무를 방해하는 행위
        <br />
        &nbsp; &nbsp;9) 외설, 폭력적인 메시지, 기타 공서양속에 반하는 정보를
        공개 또는 게시하는 행위
        <br />
        &nbsp; &nbsp;10) 해킹을 통해서 다른 사용자의 정보를 취득하는 행위
        <br />
        &nbsp; &nbsp;11) “도톨”의 동의 없이 영리, 영업, 광고, 정치활동 등을
        목적으로 서비스를 사용하는 행위
        <br />
        &nbsp; &nbsp;12) 기타 현행 법령에 위반되는 불법적인 행위 및 선량한 풍속
        기타 사회통념상 허용되지 않는 행위
        <br />
        2. “도톨”은 회원이 전항에서 금지한 행위를 하는 경우, 서비스 이용
        제한/정지, 수사 기관에의 고발 조치 등 합당한 조치를 취할 수 있습니다.
        <br />
        3. 회원은 “도톨”의 명시적 사전 동의가 없는 한 서비스의 이용권한 및 기타
        이용계약상의 지위를 제3자에게 양도, 증여, 대여할 수 없습니다.
        <br />
        4. 회원은 관계법, 약관의 규정, 이용안내 및 서비스 공지사항을 준수하여야
        하며, “도톨”의 업무에 방해되는 행위를 하여서는 안 됩니다.
        <br />
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        게임 내용이나 서비스의 수정을 위하여 필요한 경우
        <br />
        &nbsp; &nbsp;2) 해킹 등의 사고, 회원들의 비정상적인 게임 이용행태, 미처
        예상하지 못한 서비스의 불안정성에 대응하기 위하여 필요한 경우
        <br />
        &nbsp; &nbsp;3) 관련 법령에서 특정 시간 또는 방법으로 서비스 제공을
        금지하는 경우
        <br />
        &nbsp; &nbsp;4) 천재지변, 비상사태, 정전, 설비의 장애 또는 이용의 폭주
        등으로 정상적인 서비스 제공이 불가능할 경우
        <br />
        3. “도톨”은 회원과 별도로 계약을 체결하지 아니하는 한, 회원에게 “도톨”과
        관련된 어떤 권리도 부여하지 않습니다.
        <br />
        4. “도톨”이 제공하는 서비스의 기능과 디자인은 변경되거나, 중단될 수
        있습니다. “도톨”은 이와 관련하여 사전에 통지하지 않습니다.
        <br />
        5. 전항에 의해서 제공되는 서비스가 변경 및 중단될 경우에 발생한 이용자의
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        내용
        <br />
        &nbsp; &nbsp;5) 종교적, 정치적 분쟁을 야기하는 내용으로서, 이러한
        분쟁으로 인하여 서비스에 방해되거나 방해되리라고 판단되는 경우
        <br />
        &nbsp; &nbsp;6) 타인의 개인정보, 사생활을 침해하거나 명예를 손상시키는
        경우
        <br />
        ...
        민형사상의 법적 조치를 취하는 동시에 법적 조치와 관련된 게시물의 삭제를
        <br />
        &nbsp; &nbsp; 요청해오는 경우, “도톨”은 해당 게시물에 대한 접근을
        잠정적으로 제한하거나 삭제할 수 있습니다.
      </Text>
    </FlexView>
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        노출되는 광고에 동의합니다.
        <br />
        2. “도톨”은 서비스에 게재된 광고에 회원이 참여 함으로써 발생하는 손실과
        손해에 대해 책임을 지지 않습니다.
      </Text>
    </FlexView>
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        <br />
        3. 회원의 관리 소홀로 인한 ID 및 비밀번호의 유출로 제3자에 의한 부정이용
        등으로 회원의 의무조항을 위반한 경우 ID가 제한될 수 있습니다.
        <br />
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        <br />
        2. “도톨”은 회원이 작성한 게시물에 대해서 감시 및 관리할 수 없으며 이에
        대해서 책임지지 않습니다.
        <br />
        3. “도톨”은 회원이 등록하는 게시물의 신뢰성, 진실성, 정확성 등에 대해서
        책임지지 않으며 보증하지 않습니다.
        <br />
        4. 회원은 자신이 서비스 내에 게시한 게시물을 “도톨”이 다음 목적으로
        사용하는 것을 허락합니다.
        <br />
        &nbsp;&nbsp;&nbsp;1) 서비스 내에서 게시물을 사용하기 위하여 게시물의
        크기를 변환하거나 단순화하는 등의 방식으로 수정하는 것<br />
        &nbsp;&nbsp;&nbsp;2) “도톨”의 서비스를 홍보하기 위한 목적으로 미디어,
        통신사 등에게 게시물의 내용을 보도, 방영하게 하는 것.
        <br />
        5. 회원탈퇴를 하면 본인의 게시물 일체에 대한 모든 권리를 잃게 됩니다.
        작성했던 게시물은 자동으로 삭제되지 않습니다.
        <br />
        6. 회원의 게시물이 제3자의 저작권 등 지적재산권을 침해함으로써 발생하는
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        <br />
        &nbsp; &nbsp; 권리자는 관련법이 정한 절차에 따라 해당 게시물의 게시중단
        및 삭제 등을 요청할 수 있으며, “도톨”은 관련법에 따라 조치를 취합니다.
        <br />
        2. “도톨”은 전항에 따른 권리자의 요청이 없는 경우라도 권리 침해가 인정될
        만한 사유가 있거나 본 약관 및 기타 내부 정책, 관련법에
        <br />
    ...
    <FlexView gap={16}>
      <Text large={!isMobile} bold>
        제 15조. 서비스 이용의 중지 및 해지
      </Text>
      <Text small={isMobile}>
        1. 회원은 “도톨”에 언제든지 회원탈퇴를 요청할 수 있으며, “도톨”은 요청을
        받은 즉시 처리합니다.
        <br />
    ...
    <FlexView gap={16}>
      ...
      <Text small={isMobile}>
        ...
        책임을 지지 않습니다.
        <br />
        2. “도톨”은 서비스를 통해 제공된 정보의 신뢰도나 정확성을 보증하지 않고
        그로 인해 발생한 손해에 대해 책임지지 않습니다.
        <br />
        3. “도톨”은 회원 간 또는 회원과 제3자 상호간에 서비스를 매개로 하여 거래
        등을 한 경우에는 책임이 면제됩니다.
        <br />
        4. “도톨”은 서비스를 매개로 발생한 분쟁에 대해 개입할 의무가 없으며 이로
        인한 손해를 배상할 책임도 없습니다.
        <br />
