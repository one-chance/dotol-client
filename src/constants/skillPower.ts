export const SKILL_INFO: { [key: string]: { power: number; max: string } } = {
  // 전사
  ...
  "신성광폭'갈 피해증가율[+]": { power: 2, max: `100` },
  '천광방패진 쿨타임[-]': { power: 2, max: `10.0` },
  '결박 PvP 쿨타임[-]': { power: 1.334, max: `15.0` },
  '백호의희원 마력소모도[-]': { power: 2, max: `10.0` },
  '백호의희원 회복량[+]': { power: 0.667, max: `30.0` },
  '생명의비선 회복량[+]': { power: 0.667, max: `30.0` },
  '생명의비원 회복량[+]': { power: 0.667, max: `30.0` },
  '선산현원 회복량[+]': { power: 0.667, max: `30.0` },
  ...
  '측후방어 피해감소율[+]': { power: 1.334, max: `150` },
  '측후방어 고정피해감소[+]': { power: 0.001, max: `200000` },
  '그림자방패 그림자당 방어횟수[+]': { power: 40, max: `5` },
  '반탄강공 피해량[+]': { power: 0.667, max: `30.0` },
  '귀염추혼소 쿨타임[-]': { power: 4, max: `5.0` },
  '귀염추혼소 방어 감소[+]': { power: 20, max: `10` },
